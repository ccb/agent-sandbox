...
given pair's conversations — and each conversation they hold adds **another 90**
to their next wait, up to **3 windows**, so repeats space out instead of
re-opening the instant the window lapses (#803).
