...
def test_the_library_menu_is_narrowed_by_affordance(offered_tools):
    """The section's prose claims 7 of the cast's 14 Penn verbs survive the
    ...
    ``action_tools_for``, which prepends ``travel`` and ``perform`` (16
    ...
    """
    assert len(PENN_ACTION_VERBS) == 14
