...
from backend.actions import Activate, Deactivate, DrinkPenn, WaitPenn
...
PENN_EXTRA_ACTIONS = [Activate, Deactivate, DrinkPenn, Craft, WaitPenn]
...
# wait settle, so offering it is no longer a recurring-token-spend trap. Handed
# to attach_agents(extra_action_names=...) by every Penn entry point.
PENN_ACTION_VERBS = ["get", "drink", "activate", "deactivate", "make", "wait"]
