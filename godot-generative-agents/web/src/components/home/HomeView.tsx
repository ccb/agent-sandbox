...
export const TOC: { id: string; label: string; sub?: true }[] = [
  ...
  { id: "case-study", label: "One day on campus" },
 ...
 * selected-run case study (#878), limitations, acknowledgements, and
 * citations. Still to land here:
...
export function HomeView() {
  return (
    <div className="nrf">
      ...
      {/* ===== Case study: the frozen showcase run (#878) ===== */}
      <CaseStudySection />
