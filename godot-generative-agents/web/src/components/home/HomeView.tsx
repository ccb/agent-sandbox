          ...
          <div className="nrf-narrow">
            ...
            <div className="nrf-content nrf-justified">
              ...
              <p>
                ...
                <CodeRef at="conversationOutcome">
