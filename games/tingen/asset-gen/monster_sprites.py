...
MONSTERS: dict[str, str] = {
    ...
    "descended_avatar_true": "the FULLY-DESCENDED avatar of an outer god at the moment the summoning completes — a towering vast humanoid of solid night and cold starlight, no longer translucent: a crowned featureless head haloed in a broken black sun, six arms fanned in a frozen benediction, ceremonial grave-cloth orbiting it in tatters, its whole silhouette rim-lit in pale bone-light so the shape reads instantly against darkness, radiating finality and wrongness",
    "cassian_monster": "a Death-pathway curate visibly WARPED into a grave-horror, clearly no longer human: a gaunt too-tall young man in a torn black cassock, his eyes SEWN SHUT with coarse black thread and twin trails of grey grave-dust weeping down his cheeks, his raised blessing hand a fan of far too many long finger-bones, a rotted funerary stole FUSED into his shoulders like a second spine, thick black funerary smoke pooling around his hem with several faint translucent ghost-parishioners kneeling inside it, his mouth open in a silent requiem",
}
