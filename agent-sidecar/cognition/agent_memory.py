# VENDORED verbatim from ccb/agent-sandbox: text_adventure_games/memory.py (stdlib-only).
# This is agent-sandbox's actual memory framework. Do NOT edit here — re-vendor on upstream change.
# The cognition SPEC.md + test_vectors.json are derived from this file's algorithm.
"""
